...
function LoginForm() {
    ...
    const onSubmit = (data)=>{
        const role = data.email.includes("official") ? "official" : "citizen";
        localStorage.setItem("token", "dummy-token");
        localStorage.setItem("userRole", role);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`Logged in as ${role}`);
        setTimeout(()=>{
            if (role === "official") {
                router.push("/admin");
            } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e6ae4e80._.js.map